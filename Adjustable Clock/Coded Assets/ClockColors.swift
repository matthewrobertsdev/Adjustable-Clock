...
struct ClockColors{
    ...
    static let salmonCGColor=CGColor(red: 1, green: 114/255, blue: 110/255, alpha: 1)
    //orange
    static let tangurineNSColor=NSColor(calibratedRed: 255/255, green: 136/255, blue: 2/255, alpha: 1)
    static let tangurineCGColor=CGColor(red: 255/255, green: 136/255, blue: 2/255, alpha: 1)
    //yellow
    static let lemonNSColor=NSColor(calibratedRed: 255/255, green: 250/255, blue: 3/255, alpha: 1)
    static let lemonCGColor=CGColor(red: 255/255, green: 250/255, blue: 3/255, alpha: 1)
    //green
    static let springNSColor=NSColor(calibratedRed: 5/255, green: 248/255, blue: 2/255, alpha: 1)
    static let springCGColor=CGColor(red: 5/255, green: 248/255, blue: 2/255, alpha: 1)
    //blue
    static let aquaNSColor=NSColor(calibratedRed: 0, green: 144/255, blue: 1, alpha: 1)
    static let aquaCGColor=CGColor(red: 0, green: 144/255, blue: 1, alpha: 1)
    //purple
    static let grapeNSColor=NSColor(calibratedRed: 137/255, green: 49/255, blue: 255/255, alpha: 1)
    static let grapeCGColor=CGColor(red: 137/255, green: 49/255, blue: 255/255, alpha: 1)
